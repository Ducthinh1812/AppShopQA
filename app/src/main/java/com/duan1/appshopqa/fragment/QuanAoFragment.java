...
public class QuanAoFragment extends Fragment {
    ...
    String urlGetQA = "https://cyclothymic-floors.000webhostapp.com/DBShopQuanAo/getQA.php";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable  ViewGroup container, @Nullable  Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_quanao, container, false);
    }
...
//        toolbar = view.findViewById(R.id.toolBarQA);
        recyclerView = view.findViewById(R.id.lvQuanAo);
